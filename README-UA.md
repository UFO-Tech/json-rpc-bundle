...
### Версія 4.2
- Впроваджена мультипроцесна обробка batch запитів, що зменшує час відповіді до часу найдовшого запиту
...
```
### Версія 4.1
- Повноцінна підтримка batch запитів з можливістю передачі результатів одного запиту, до параметрів другого
